...
```text
รับค่า input จำนวนคำสั่ง
รับค่า input เป็นเครื่องหมาย +,- ตามจำนวนคำสั่ง เช่น 5 = input 5ครั้ง
constraint : หาก input เป็นเครื่องหมาย +, จะบวก 10เเต้ม
หาก input เป็นเครื่องหมาย -, จะลด 5 คะเเนน
```
...
```text
รับค่าจำนวนคำสั่งเป็น int 
จากนั้นสร้างตัวเเปร TOTAL เพื่อเก็บค่า
จากนั้นใช้ for loop เเละให้ input n ครั้ง ตามจำนวนคำสั่ง
ใช้ condition หาก input เป็น +, totaal จะ += 10
หากเป็น -, total จะ -= 5
print Total
```
...
```text
หากจำนวนคำสั่งเป็นลบ จะมีให้inputเครื่องหมายหรือไม่
```
