...
```text
input : ค่าอาหาร
output : ค่าใช้จ่ายทั้งหมด (ค่าอาหาร + ค่าบริการ + vat7%)
constraints : ค่าบริการคิดเป็น 10% ของค่าอาหาร ขั้นต่ำ 50 มากสุด 1000
...
```text
Step 1:รับ input  ค่าอาหาร
Step 2: คิดค่าบริการ เเละ ภาษี
```
...
```text
สร้างตัวเเปรรับ input ค่าอาหาร
สร้างตัวเเปรค่าบริการ นำค่าอาหารมา*0.1 คิดเป็น 10% ของค่าอาหาร
ใช้ if elif else
โดยหากค่าบริการที่คิดได้ น้อยกว่า 50
ค่าบริการ จะเท่ากับ 50
เเละหากค่าบริการมากกว่า 1000
ค่าบริการ จะเท่ากับ 1000
สร้างตัวเเปร sum1 = ค่าอาหาร + ค่าบริการ
สร้างตัวเเปร sum2 = sum1 x 1.07 (คิด vat 7% = 107/100 = 1.07)
print sum2 โดยคิดเป็นทศนิยม 2ตำเเหน่ง
```
...
```text
เพื่อตรวจสอบหากค่าบริการน้อยกว่า 50
ค่าบริการจะเท่ากับ 50
```
...
```text
เพื่อตรวจสอบว่าค่าบริการคิดเกิน 1000 หรือไม่
```
...
```text
เพื่อตรวจสอบว่าราคาปกติ สามารถทำได้ถูกต้องหรือไม่
```
...
```text
ช่วย review first plan
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโปรเเกรมทั้งหมด เเละได้วางเเผนใหม่
```
