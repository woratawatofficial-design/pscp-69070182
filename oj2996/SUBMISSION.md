...
```text
input : ตัวอักษรภาษาอังกฤษ
output : input เรียงกลับหน้าไปหลัง
constraints : inputต้องมี 5ตัวอักษร
...
```text
Step 1:รับ input
Step 2:ตรวจสอบว่า input มี 5ตัวอักษรหรือไม่
Step 3:ถ้ามี ให้เปลี่ยนตัวอักษรเป็นพิมพ์เล็ก เเละ เเละสลับหน้าหลัง
Step 4: พิมพ์ output
```
...
```text
สร้างตัวเเปร์ text ไว้เก็บค่า input จากนั้นใช้ if เเละใช้ len เพื่อตรวจว่าinput มีตัวอักษร 5ตัวหรือไม่ ถ้าใช่ก็จะใช้ lower() เพื่อทำให้ตัวอักษรเป็นพิมพ์เล็ก จากนั้นใช้ [::-1] เพื่อสลับหน้าไปหลัง เเล้ว print text
```
...
```text
เพราะมีตัวอักษร 5ตัวพอดี เเละมีตัวพิมพ์ใหญ่
```
