...
```text
รับ input a,b,d,r โดย A คือเลขเริ่มต้น B คือเลขสุดท้าย dคือตัวหาร เเละ r คือเศษที่ต้องได้
output คือจำนวนตั้งเเต่ A ถึง B ที่หาร D เเล้วได้เศษ R
...
```text
รับ input a,b,d,r จากนั้นสร้างตัวเเปร total = 0 ไว้สำหรับเก็บค่าตัวระหว่าง a-b ที่หาร dได้เศษ r
ใช้ for loop กำหนด start = a, stop = b, step = d
ใช้ condition ถ้า i หาร d ได้ r , total += 1
```
...
```text
คล้ายเเผนเเรก เเต่เเก้ตรง for loop เป็น for i in range(A,B+1) เพราะเอาค่า Bด้วย
จากกนั้นใช้ condition if i % d ได้เศษ r
total += 1
เเละ print total
```
...
```text
หาก d มีค่ามากกว่า a ถึง b เเละเศษที่ต้องการคือ 0 จะได้อะไร
```
...
```text
หากไม่สามารถหาจำนวนที่หาร d เเล้วได้เศษ r จะได้ผลลัพธ์เป็นอะไร
```
...
```text
หากinput ตามปกติผลลัพธ์ที่ได้จะทำงานปกติหรือไม่
```
