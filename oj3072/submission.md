...
```text
รับ input เป็นข้อความโดยตัวใหญ่ตัวเล็ก ถือว่าเป็นตัวเดียวกัน โดยจะนับ a e i o u หรือ vowels
หาก input มี vowel จะ print ตัวที่มีเเละจำนวนที่มี
...
```text
รับ X input เป็น string จากนั้นใช้ .lower() เพื่อให้ input เป็นตัวพิมพ์เล้กทั้งหมด
สร้างตัวเเปร countA,countE,countI,countO,countU เพือเก็บค่่า vowel
ใช้ for loop โดยเช็ค
for i in X เเละสร้าง condition หาก i มี a,e,i,o,u ค่า count จะ +=1
เเละสร้าง condition หากค่า count มีค่ามากกว่าเท่ากับ1 จะprint ค่าcount ด้วย f string ตัวอักษร เเละ count ที่ได้
```
...
```text
หากมีตัวพิมพ์เล็กเเละพิมพ์ใหญ่ จะcount อยู่ไหม
```
