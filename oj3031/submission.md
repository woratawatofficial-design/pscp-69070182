...
```text
input : พื้นที่ที่น้ำหมึกกระจาย เเละ จำนวนคนที่ร้องเรียน
input : ตำเเหน่งบ้านตามจำนวนของคนที่ร้องเรียน
output : วินาทีที่บ้านผู้ร้องเรียนจะถูกหมึกจม
constraint : pi = 3.1416 , input เป็นจำนวนเต็ม
...
```text
Step 1 : รับ input พื้นที่น้ำหมึก เเละ จำนวนคนร้องเรียน
Step 2 : ใช้ for loop เพื่อรับค่าตำเเหน่งบ้านของผู้ร้องเรียน
```
...
```text
จะทำต่อจาก First Plan ที่
Step 1 : รับ input พื้นที่น้ำหมึก เเละ จำนวนคนร้องเรียน
Step 2 : ใช้ for loop เพื่อรับค่าตำเเหน่งบ้านของผู้ร้องเรียน
จากนั้นใช้หาระยะห่างระหว่างจุด เนื่องจาก d = r เพราะเเผ่เป็นวงกลมเรื่อยๆ
จากนั้นใช้สูตร 3.1416 * D^2 หาพื้นที่ของจุดบ้าน
เเละทำ พื้นที่บ้านของผู้เรียกร้องมาหารกับ Input พื้นที่น้ำหมึก เพื่อหาว่าอีกกี่วินาทีจะถมบ้านได้
Output = วินาทีที่หมึถมบ้าน
```
...
```text
เพื่อตรวจสอบว่าหากพื้นที่เป็นลบ จะเป็นอย่างไร
```
...
```text
ควรจะหาวินาทีไม่ได้ เพราะพื้นที่เเละวินาทีติดลบ
```
...
```text
เพื่อตรวจสอบว่า หากบ้านอยู่พิกัด 0 0 วินาทีจะเป็น 0 หรือ 1 ที่บ้านโดนถล่ม
```
...
```text
ถ้าไม่มีผู้ร้องเรียน จะเป็นอย่างไร
```
