...
```text
เพื่อตรวจสอบว่าหากอยู่ตำเเหน่ง 1 จะขยับหรือไม่
```
...
```text
0 เพราะจาก logic ที่คิดไว้คือหากอยู่ชั้นเลขคี่ เเล้วเลขเป็นเลขคี่ การขยับจะเท่ากับ ตัวเอง - 1 คูณ 2 เท่ากับจะไม่ขยับเลยในกรณีนี้
```
...
```text
เพื่อตรวจสอบความถูกต้องของชั้นเลขคู่ ถ้าหากอยู่ชั้นเลขคู่ เเล้ว X เป็นเลขคู่ จะต้องเดินเท่ากับ ชั้น-1 เเล้วคูณ 2
```
...
```text
6 ในกรณีนี้ 14 อยู่ชั้นที่ 4 เเละถ้าหากถูกต้อง จะต้องได้ (4-1)*2 = 6ก้าว
```
...
```text
เพื่อตรวจสอบว่าหากอยู่ชั้นเลขคี่เเละ input เป็นเลขคี่ จะได้คำตอบตามสูตร ก้าว = (ชั้นเลขคี่-1)*2 หรือไม่
```
...
```text
8 เพราะ 21อยู่ชั้น 5 เเละ (5-1)*2 = 8ก้าว
```
