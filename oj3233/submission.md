...
รับ string input A
รับ string input B
output เป็นรางวัลตามเงื่อนไขที่กำหนด
constraint : หากไม่ถูกรางวัล print 0
```
...
```text
รับ input A คือฉลากชุดเเรก
input B ฉลากชุด 2
สร้าง condition ถ้า A = B ทุกประการ output = 1000000
สร้าง condition หาก A[0] != B[0] เเต่ตัวที่เหลือเหมือนกัน จะได้ 100000
จากนั้นสร้าง condition ใหญ่ หากตัวหน้าตรง หรือ A[0] B[0]
สร้างเงื่อนไขตามโจทย์
เเละสร้างอีก condition ใหย่คือกรณีที่ตัวหน้าไม่ตรง A[0] != B[0]
output ตามโจทย์
```
...
```text
เหมือนกับเเผนเเรกเพราะทำถูกในครั้งเเรก
```
...
```text
หากตัวหน้าเดียวัน เเต่พิมพ์เล็กพิมพ์ใหญ่ต่างกัน
```
...
```text
หากมีเเค่ 4หลัก เเต่หลักหน้าไม่ตรง
```
