...
output : จำนวน input ลบที่ละ 10 จนถึง 0
...
```text
Step 1 : รับ input N
Step 2 : ใช้ While loop เนื่องจากจะหารจนกว่า input จะเหลือ 0 ตั้งเงื่อนไข While N >= 0
Step 3 : สร้าง Condition เพื่อเช็คว่า N ที่ inputมา หาร 10ลงตัวไหม หรือ มีเศษหรือเปล่า
Step 4 : หากหารมีเศษ ให้นำ N - เศษ เเล้วทำการloop ลบ 10 เเล้ว print หากไม่มีเศษ print N - 10 เรื่อยๆ
```
...
```text
ถ้า input เป็นจำนวนเต็มลบ จะเป็นอย่างไร
```
...
```text
หากinput หาร 10 เเล้วเหลือเศษ จะเป็นอย่างไร
```
