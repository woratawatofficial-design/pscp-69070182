...
```text
ได้รู้ว่าสามารถทำอีกวิธีนึงได้โดยนำค่าสูงสุดคูณ 2 ในเมื่อมีคน 3คน หากสูงสุด2คน คนที่3คือคนที่ให้รีวิวต่ำที่สุดเเน่นอน
โดยโค้ดเดิมของผมคือ นำคะเเนนสูงสุดมา - (ผลรวม//3) ซึ่งจะได้ค่าที่ไม่เเน่ชัด
```
...
```text
ได้เริ่มวาง logic ใหม่เเล้วเขียนโปรเเกรมใหม่ทั้งหมดด้วยตัวเอง
หลังจากที่ส่งผ่านครั้งเเรก ก็ได้ลองวิธ๊อื่นๆเรื่อยๆให้โค้ดสั้นลงเเละใช้วิธีที่ง่ายกว่าเดิม
```
...
```text
ได้เรียนรู้ที่จะกล้าลองสิ่งใหม่ๆ เเละได้รู้วิธีการเเก้โจทย์
ที่ให้ข้อมูลไม่ครบ หรือ วิธีการหาผลลัพท์ความเป็นไปได้ หากรู้ input เเค่ 1 input
จากโจทย์คือ 3คน รู้1
```
