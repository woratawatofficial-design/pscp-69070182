...
```text
รับ input 3 ตัว ของสีที่ 1
รับ input 3 ตัว ของสีที่ 2
นำทั้งสองสีผสมกัน เเละ print
constraint : input ที่รับ บรรทัดเดียวกัน
```
...
```text
บรรทัดเเรกรับ input x1,y1,z1 ใช้ map(int,input().split())
ใช้ split เพื่อเเยกเเต่ละตัว
ทำเเบบนี้กับ บรรทัดที่สอง x2,y2,z2
จากนั้นสร้างตัวเเปร
newx,newy,newz โดยทำ ค่าเเรก เเละค่าที่สองมาบวกกันเเล้วปัดเศษ
```
