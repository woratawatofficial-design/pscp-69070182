...
```text
รับ input 2ค่าใน 1บรรทัด คือ string ชื่อสถานีต้นทางเเละปลายทาง
จากนั้นรับน้ำหนักของพัสดุ เป็น float
output : ค่าส่งพัสดุ
...
```text
รับ input L1,L2 เป็น string จากนั้นใช้ upper เเละ split
รับ float input เป็นน้ำหนักของพัสดุ เก็บในตัวเเปร S
ใช้ condition ในเเต่ละสถานี หาก L1 เเละ L2 เป็นสถานีที่สอดคล้องกับตารางที่โจทย์ให้มาจะ printค่าธรรมเนียมเริ่มต้น บวกกับ ค่าธรรมเนียมน้ำหนัก*S ทศนิยม 2ตำเเหน่ง
```
